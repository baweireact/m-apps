...
const Detail = (props) => {
  ...
  return (
    <div className="m-main">
      ...
      <div>
        <button onClick={handleSub} className="m-btn">-</button>
        <input placeholder="请输入" value={detail.count} className="m-add-count" onChange={handleInput} type="text"></input>
        <button onClick={handleAdd} className="m-btn">+</button>
        <button onClick={handleAddToMyBook} className="m-btn">添加</button>
      </div>
